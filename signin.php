        ...
        <main>
            <div class="max-w-sm mx-auto bg-white rounded-md shadow-md p-6">
                <form action="addUser.php" method="POST">
                    ...
                    <input type="password" id="password" name="password" placeholder="Confirma la contraseña" class="w-full px-4 py-2 mb-4 text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" required>
